...
def setParam(mr, mrl, dur):

    global min_daily_rate, xday_threshold, xdays, testVal
    min_daily_rate = mr / 100 
    xday_threshold = mrl / 100
    xdays = dur
    testVal = dur

    print "______SetParam__________"
    print min_daily_rate
    print xday_threshold
    print xdays
    print testVal
    print "______SetParam__________"
...
def lend_all():
    ...
    print sleep_time
    print "Will be waiting for next try"
