...
log = Logger(Config.get('BOT', 'jsonfile', '') + 'speedTest_.json', Decimal(Config.get('BOT', 'jsonlogsize', -1)))
#api = Poloniex(Config.get("API", "apikey", None), Config.get("API", "secret", None))

apikey = "S1SXWZ8K-ZME46XUI-XAH071TS-26GT5D8N"
secret = "cf274c877e4186cb7bba2f274b8c23ee4300632824f53161f72976dce06d98e48715648289473d4c355bd6718e363685281916c6dfb13ad1be08c41770a20ec5"
